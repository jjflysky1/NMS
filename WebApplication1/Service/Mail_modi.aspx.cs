...
namespace WebApplication1
{
    public partial class Mail_modi : System.Web.UI.Page
    {
        ...
        {
            SQL = "select distinct b.no, id,pwd,b.name,duty,b.email, b.phone,serverip  from service a , user_ba b where serverip = '" + HiddenField10.Value + "' order by no desc";
            ...
            {
                TBLADD(row["no"].ToString(), row["id"].ToString(), row["pwd"].ToString(), row["name"].ToString(), row["duty"].ToString(), row["phone"].ToString()
                    , row["serverip"].ToString(), row["email"].ToString());
        ...
        private void TBLLOAD1()
        {
            ...
            SQL = "select distinct  b.no, id,pwd,b.name,b.phone,duty,c.email,  c.serverip, c.mailno from service a , user_ba b, mail_target c " +
        ...
        long a = 1;
        private void TBLADD(string NO, string id, string pwd, string name, string duty, string phone, string serverip ,string email)
        {
            TableRow TR;
            TableCell TD;
        ...
        protected void Button20_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "insert into mail_target(serverip,mailno,phone,email) values(@serverip, @mailno ,@phone, @email)";
            cmd.Parameters.Add("@serverip", MySqlDbType.VarChar, 100).Value = HiddenField10.Value;

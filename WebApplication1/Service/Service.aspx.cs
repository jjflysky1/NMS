...
namespace WebApplication1
{
    public partial class Service : System.Web.UI.Page
    {
        ...
        private void TBLLOAD()
        {
            ...
            //MySqlDataAdapter ADT = new MySqlDataAdapter("service_list", DB);
            ...
            string network_name, string category, string dash_flag)
        {
            ...
            {
                SB.Append("<button style='width:150px' class='btn btn-success dropdown-toggle' type='button' data-toggle='dropdown'>" + category.ToString() + "");
            }
            ...
            //SB.Append("<li><a href='#' onClick=category('" + serverip.ToString() + "','AP');return false;>AP</a></li>");
            ...
            TD.Width = 10;
                ...
                TD.Text = "<asp:button type='button' ID='Button2' class='btn btn-primary btn-middle' runat='server'><span class='glyphicon glyphicon-share' style='color:white;'></span> 알림 수정</button>";
        ...
        protected void Button9_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.Add("@serverip", MySqlDbType.VarChar, 100).Value = HiddenField3.Value;
            cmd.ExecuteNonQuery();
            cmd.Dispose();
            cmd = null;
            ...
            cmd1.Parameters.Add("@serverip", MySqlDbType.VarChar, 100).Value = HiddenField3.Value;
            ...
            cmd2.Parameters.Add("@serverip", MySqlDbType.VarChar, 100).Value = HiddenField3.Value;

    ...
    public partial class Oid_List : System.Web.UI.Page
    {
        ...
        private void PAGEADD(double pagecount, int nowpage)
        {
            ...
            for (int i = nowpage; i < pagecount; i++)
            {
                ...
                SB.Append("<li> " + "<a href='oid_list.aspx?nowpage=" + i + "&search=" + Search.Text + "&type1=" + DropDownList1.SelectedValue + "&type2="+ DropDownList2.SelectedValue +"'>" + i + "</a>" + " <li>");
        ...
        private void TBLLOAD()
        {
            ...
            MySqlDataAdapter ADT = new MySqlDataAdapter("Oid_List_sp", DB);
        ...
        protected void Button9_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = DB;
            cmd.CommandType = System.Data.CommandType.Text;
            cmd.CommandText = "delete from all_oid where no = @no";
            cmd.Parameters.Add("@no", MySqlDbType.VarChar, 100).Value = HiddenField3.Value;
            cmd.ExecuteNonQuery();
            cmd.Dispose();
            cmd = null;
        ...
        protected void Button1_Click2(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.Add("@model", MySqlDbType.VarChar, 100).Value = Model.Text;
            cmd.Parameters.Add("@oid", MySqlDbType.VarChar, 100).Value = OID.Text;
            cmd.Parameters.Add("@description", MySqlDbType.VarChar, 100).Value = Description.SelectedValue;
            cmd.ExecuteNonQuery();

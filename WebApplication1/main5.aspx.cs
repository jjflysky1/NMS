...
{
    public partial class main5 : System.Web.UI.Page
    {
        ...
        private void TBLSET()
        {
            ...
            TD.Width = 20;
            TD.Text = "서버 아이피";
            TD.Attributes["style"] = "text-align : center; vertical-align:middle; color:black;";
            TR.Cells.Add(TD);
        ...
        private void TBLSET2()
        {
            ...
            TD.Text = "<a href='Service/Service.aspx' style='color:black'>전체</a>";
            ...
            TD = new TableHeaderCell();
            TD.Width = new Unit("10%");
            TD.Text = "<a href='Service/Service.aspx' style='color:black'>장애</a>";
            TD.Attributes["style"] = "text-align : center; cursor:pointer;";
            TD.Attributes.Add("onmouseover", "this.style.color='green'");
            ...
            TD.Width = new Unit("10%");
            TD.Text = "관리 장비";
            TD.Attributes["style"] = "text-align : center; cursor:pointer; color:black;";
        ...
        private void TBLSET3()
        {
            ...
            TD = new TableHeaderCell();
            TD.Width = new Unit("10%");
            TD.Text = "<a href='Log/Service_Log.aspx' style='color:black'>서비스</a>";
            TD.Attributes["style"] = "text-align : center; cursor:pointer;";
            //TD.Attributes.Add("onmouseover", "this.style.color='green'");
            //TD.Attributes.Add("onmouseout", "this.style.color='black'");
            TR.Cells.Add(TD);
        ...
        private void TBLADD2(string allcount, string alivecount, string Server, string security, string pc, string none, string ap, string error_count)
        {
            ...
            if (error_count == "0")
            {
                TD.Text = "<font size='5'><b><a href='Service/Service.aspx' style='color:black'>" + error_count.ToString() + "</a></b></font>";
            }
            else
            {
            ...
            TD.Attributes["style"] = "text-align : center; vertical-align:middle; cursor:pointer; color:black;";
            TD.Attributes.Add("Onclick", "go('')");
            //TD.Attributes.Add("onmouseover", "this.style.color='green'");
            //TD.Attributes.Add("onmouseout", "this.style.color='black'");
            TR.Cells.Add(TD);
            ...
            //TD.Attributes["style"] = "text-align : center; vertical-align:middle; cursor:pointer; color:black;";
            //TD.Attributes.Add("Onclick", "go('pc')");
            ////TD.At0-tributes.Add("onmouseover", "this.style.color='green'");
            ////TD.Attributes.Add("onmouseout", "this.style.color='black'");
            //TR.Cells.Add(TD);
        ...
        {
            SQL = "select distinct os,name,serverip,serverid,serverpwd,status,network_name,computer_name,category from Service where status <> 'Server Connect' and flag = 1 AND category IS NOT null limit 3 ";
            MySqlDataAdapter ADT = new MySqlDataAdapter(SQL, DB);
            DataSet DBSET = new DataSet();
            ADT.Fill(DBSET, "BD");
            string status = "";

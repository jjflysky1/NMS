...
namespace WebApplication1
{
    ...
    public partial class System_Log_Main : System.Web.UI.Page
    {
        ...
        private void TBLLOAD()
        {
            ...
            string SQL2 = "select count(*) as count from service_server ";
            if (DropDownList1.SelectedValue == "1")
            {
                SQL2 = "select count(*) as count from service_server where serverip like '%" + Search.Text + "%'";
            ...
            MySqlDataAdapter ADT = new MySqlDataAdapter("system_Log_list_main", DB);
        ...
        private void count()
        {
            SQL = "select count(*) as count from service_server";

            if (DropDownList1.SelectedValue == "1")
            {
                SQL = "select count(*) as count from service_server where serverip like '%" + Search.Text + "%'";
        ...
        private void PAGEADD(int pagecount, int nowpage)
        {
            ...
            SB.Append("<li>" + "<a href='System_Log.aspx?nowpage=" + 1 + "&search=" + Search.Text + "&type=" + DropDownList1.SelectedValue + "&type2=" + DropDownList2.SelectedValue + "'>" + "<span aria-hidden='true'> &laquo;</span>" + "</a>" + "<li>");
            if (nowpage > 5)
            {
                nowpage = nowpage - 3;
            }
            ...
            for (int i = nowpage; i < pagecount; i++)
            {
                ...
                SB.Append("<li> " + "<a href='System_Log.aspx?nowpage=" + i + "&search=" + Search.Text + "&type=" + DropDownList1.SelectedValue + "&type2=" + DropDownList2.SelectedValue + "'>" + i + "</a>" + " <li>");

            }
            SB.Append("<li>" + "<a href='System_Log.aspx?nowpage=" + (pagecount - 1) + "&search=" + Search.Text + "&type=" + DropDownList1.SelectedValue +"&type2=" + DropDownList2.SelectedValue + "'>" + "<span aria-hidden='true'> &raquo;</span>" + "</a>" + "<li>");
        ...
        {
            Response.Redirect("System_Log_Main.aspx?nowpage=" + 1 + "&search=" + Search.Text + "&type=" + DropDownList1.SelectedValue);
        }
        ...
        protected void Button6_Click(object sender, EventArgs e)
        {
            ...
            {
                SQL2 = "select count(*) as count from service_server where time like '%" + Search.Text + "%' ";
            }
            else if (DropDownList1.SelectedValue == "4")
            {
                SQL2 = "select count(*) as count from service_server where status like '%" + Search.Text + "%' ";
            }
        ...
        {
            Response.Redirect("System_Log.aspx?serverip="+ serverip.Value);
        }
    }
}
...
namespace WebApplication1
{
    ...
    public partial class period_traffic_main : System.Web.UI.Page
    {
        ...
        private void PAGEADD(int pagecount, int nowpage)
        {
            ...
            SB.Append("<li>" + "<a href='period_traffic_main.aspx?nowpage=" + 1 + "&search=" + Search.Text + "&type=" + DropDownList1.SelectedValue + "&type2=" + DropDownList2.SelectedValue + "'>" + "<span aria-hidden='true'> &laquo;</span>" + "</a>" + "<li>");
            if (nowpage > 5)
            {
                nowpage = nowpage - 3;
            }
            ...
            for (int i = nowpage; i < pagecount; i++)
            {
                ...
                SB.Append("<li> " + "<a href='period_traffic_main.aspx?nowpage=" + i + "&search=" + Search.Text + "&type=" + DropDownList1.SelectedValue + "&type2=" + DropDownList2.SelectedValue + "'>" + i + "</a>" + " <li>");

            }
            SB.Append("<li>" + "<a href='period_traffic_main.aspx?nowpage=" + (pagecount - 1) + "&search=" + Search.Text + "&type=" + DropDownList1.SelectedValue + "&type2=" + DropDownList2.SelectedValue + "'>" + "<span aria-hidden='true'> &raquo;</span>" + "</a>" + "<li>");
        ...
        {
            Response.Redirect("period_traffic_main.aspx?nowpage=" + 1 + "&search=" + Search.Text + "&type=" + DropDownList1.SelectedValue);
        }
        ...
        {
            Response.Redirect("perioid_traffic.aspx?serverip=" + serverip.Value + "&view_type=secure_log");
        }
    }
}
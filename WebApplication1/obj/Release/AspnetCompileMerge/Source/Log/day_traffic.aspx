...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    $.ajax({
        ...
        timeout: 60000
                                    ...
                                    최대값<br />
                                    <asp:Label ID="Label46" runat="server" Text="Label" Font-Size="Smaller"></asp:Label>
                                    <font size="2">mbps</font><br />
    ...
    $.ajax({
        ...
        timeout: 60000
                                    ...
                                    최대값<br />
                                    <asp:Label ID="Label49" runat="server" Text="Label" Font-Size="Smaller"></asp:Label>
                                    <font size="2">mbps</font><br />

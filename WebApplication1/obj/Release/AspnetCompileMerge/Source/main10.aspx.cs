...
{
    public partial class main10 : System.Web.UI.Page
    {
        ...
        {
            TableRow TR, TR1, TR2, TR3, TR4, TR5, TR6;
            TableCell TD, TD1, TD2, TD3, TD4, TD5, TD6;
            ...
            TD = new TableCell();
            TD.Width = 60;
            TD.Text = "<div class=\"text-middle font-weight-bold text-success text-uppercase mb-1\">\r\n Total</div><font size='5'><b><a href='Service/Service.aspx' style='color:#000000'>" + allcount.ToString() + "</a></b></font>";
            ...
            TD1 = new TableCell();
            TD1.Width = 60;
            TD1.Text = "<div class=\"text-middle font-weight-bold text-success text-uppercase mb-1\">\r\n Management Amount</div><font size='5' color='#000000'><b>" + alivecount.ToString() + "</b></font>";
            TD1.Attributes["style"] = "text-align:center; vertical-align:middle; cursor:pointer;";
            TD1.Attributes.Add("Onclick", "go('')");
            TD1.Attributes.Add("onmouseover", "this.style.color='white'");
            TD1.Attributes.Add("onmouseout", "this.style.color='white'");
            TR1.Cells.Add(TD1);

            TBLLIST01.Rows.Add(TR1);

            TD2 = new TableCell();
            TD2.Width = 60;
            TD2.Text = "<div class=\"text-middle font-weight-bold text-success text-uppercase mb-1\">\r\n Network / Security</div><font size='5' color='#000000'><b>" + security.ToString() + "</b></font>";
            TD2.Attributes["style"] = "text-align : center; vertical-align:middle; cursor:pointer; ";
            TD2.Attributes.Add("Onclick", "go('네트워크')");
            TD2.Attributes.Add("onmouseover", "this.style.color='white'");
            TD2.Attributes.Add("onmouseout", "this.style.color='white'");
            TR2.Cells.Add(TD2);

            TBLLIST02.Rows.Add(TR2);

            TD3 = new TableCell();
            TD3.Width = 60;
            TD3.Text = "<div class=\"text-middle font-weight-bold text-success text-uppercase mb-1\">\r\n Server</div><font size='5' color='#000000'><b>" + Server.ToString() + "</b></font>";
            TD3.Attributes["style"] = "text-align : center; vertical-align:middle; cursor:pointer; ";
            TD3.Attributes.Add("Onclick", "go('서버')");
            TD3.Attributes.Add("onmouseover", "this.style.color='white'");
            TD3.Attributes.Add("onmouseout", "this.style.color='white'");
            TR3.Cells.Add(TD3);


            TBLLIST03.Rows.Add(TR3);

            TD4 = new TableCell();
            TD4.Width = 60;
            TD4.Text = "<div class=\"text-middle font-weight-bold text-success text-uppercase mb-1\">\r\n PC</div><font size='5' color='#000000'><b>" + pc.ToString() + "</b></font>";
            TD4.Attributes["style"] = "text-align : center; vertical-align:middle; cursor:pointer; ";
            TD4.Attributes.Add("Onclick", "go('pc')");
            TD4.Attributes.Add("onmouseover", "this.style.color='white'");
            TD4.Attributes.Add("onmouseout", "this.style.color='white'");
            TR4.Cells.Add(TD4);

            TBLLIST04.Rows.Add(TR4);

            TD5 = new TableCell();
            TD5.Width = 60;
            TD5.Text = "<div class=\"text-middle font-weight-bold text-success text-uppercase mb-1\">\r\n NONE</div><font size='5' color='#000000'><b>" + none.ToString() + "</b></font>";
            TD5.Attributes["style"] = "text-align : center; vertical-align:middle; cursor:pointer; ";
            TD5.Attributes.Add("Onclick", "go('null')");
            TD5.Attributes.Add("onmouseover", "this.style.color='white'");
            TD5.Attributes.Add("onmouseout", "this.style.color='white'");
            TR5.Cells.Add(TD5);

            TBLLIST05.Rows.Add(TR5);

            TD6 = new TableCell();
            TD6.Width = 60;
            TD6.Text = "<div class=\"text-middle font-weight-bold text-danger text-uppercase mb-1\">\r\n Service Down</div><font size='5' color='red'><b>" + downcount.ToString() + "</b></font>";
            TD6.Attributes["style"] = "text-align : center; vertical-align:middle; cursor:pointer; ";
            TD6.Attributes.Add("Onclick", "go3('null')");
            TD6.Attributes.Add("onmouseover", "this.style.color='white'");
            TD6.Attributes.Add("onmouseout", "this.style.color='white'");
            TR6.Cells.Add(TD6);

            TBLLIST06.Rows.Add(TR6);
            ...
            string hd, string network_name, string computer_name, string category)
        {
            ...
            //    " </div></div>";
            TD.Text = cpu.ToString() + "%" + "<div class='meter2' style='width:100%'><span style='width:" + cpu.ToString() + "%'></span></div>";
            ...
            TD.Text = memory.ToString() + "%" + "<div class='meter' style='width:100%'><span style='width:" + memory.ToString() + "%'></span></div>";

<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="Secure_Log.aspx.cs" Inherits="WebApplication1.Secure_Log" %>
    ...
    <section class="content">
    	  ...
    	  <div class="">
		    ...
		    <div class="navbar-btn " style="margin-left:10px;margin-right: 10px" >
                <ui class="nav navbar-nav navbar-left">
                 ...
                 <%--          <li style="margin-left:50px; margin-right:10px">
                               <Button ID="Button101" runat="server"   OnserverClick="Button101_ServerClick" Class="btn btn-success btn-sm">
                               1분    
                               </Button>
                            </li>
                    <li style=" margin-right:10px">
                                  <Button ID="Button4" runat="server"   OnserverClick="Button4_ServerClick" Class="btn btn-success btn-sm">
                               5분    
                               </Button>
                            </li>
                    <li style=" margin-right:10px">
                                  <Button ID="Button5" runat="server"   OnserverClick="Button5_ServerClick" Class="btn btn-success btn-sm">
                               30분    
                               </Button>
                            </li>
                    <li style=" margin-right:10px">
                                  <Button ID="Button6" runat="server"   OnserverClick="Button6_ServerClick" Class="btn btn-success btn-sm">
                               60분    
                               </Button>
                            </li>--%>
                ...
                <ui class="nav navbar-nav navbar-right">
                    ...
                    <li style=" margin-right:10px">
                        ...
                        <%--<ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" Format="yyyy-MM-dd" TargetControlID="startdate" />--%>
                    ...
                    <li style=" margin-right:10px">
                        ...
                        <%--<ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" Format="yyyy-MM-dd" TargetControlID="enddate" />--%>
                    </li>
                    <li style="margin-top:5px; margin-right:10px">
       ...
       <uc2:uc_bottom ID="uc_bottom" runat="server" />
                ...
                <asp:HiddenField ID="serverip" runat="server" />
                  <asp:HiddenField ID="view_type" runat="server" />

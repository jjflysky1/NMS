            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="#">서비스로그</a></li>
                    </ol>
                </section>
                                ...
                                <div class="">
                                    ...
                                    <div class="navbar-btn " style="margin-left: 10px; margin-right: 10px">
                                        <ui class="nav navbar-nav navbar-left">
                                            <li>
                                                <button id="Button3" text="엑셀 저장" runat="server" onserverclick="Button6_Click" class="btn btn-primary btn-sm">
                                        ...
                                        <ui class="nav navbar-nav navbar-right">
                                            ...
                                            <li style="margin-right: 10px">
                                                <asp:Button ID="Button12" runat="server" Text="검색" CssClass="btn btn-primary btn-sm" OnClick="Button3_Click" />
                                            </li>
                                        </ui>
                                    </div>
                                </div>

<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="Chart2.aspx.cs" Inherits="WebApplication1.Chart2" %>
...
<body style="background-color:#fafafa; width:30%">
    <style>
     ...
     <%--    <div id="mysecchart" style="z-index:99; width:100%; margin-right:0px; background-color:white;margin-left:0px;  height: 150px; cursor:pointer;"></div>

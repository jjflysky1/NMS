<%@ Page Language="C#" MaintainScrollPositionOnPostback="true" EnableEventValidation="false"  AutoEventWireup="true" CodeBehind="Main3.aspx.cs" Inherits="WebApplication1.Main3" %>
...
<script src="Scripts/exporting.js"></script>
<script src="Scripts/kr-all.js"></script>
    <title></title>
...
getUserIP(function (ip) {
    ...
    $.get('mainicon2.aspx', function (data) {
            ...
            <div style=" width:30%; margin-left:1%; ">
                <section class="connectedSortable">
                        <div  class="box box-info" style="float:left;  width:100%;  margin-top:auto; padding-left:2%;  margin-left:1%;  z-index:99;">
                              <div style="margin-left:2%" class="box-header">
                              <h4>

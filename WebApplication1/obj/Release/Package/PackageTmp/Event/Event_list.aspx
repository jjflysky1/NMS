<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="Event_list.aspx.cs" Inherits="WebApplication1.Event_list" %>
       ...
       <div class="content-wrapper">
            ...
            <section class="content-header">
              ...
              <ol class="breadcrumb">
                ...
                <li class="active"><a href="#">이벤트리스트</a></li>
              </ol>
            </section>
		    ...
		    <div class="navbar-btn navbar-right"  style="margin-right: 10px">
                <ui class="nav navbar-nav navbar-right">
                 ...
                 <%--   <li style="margin-top:5px; margin-right:10px">
                   ...
                   <li style="margin-top:5px;  margin-right:10px">
                       <asp:Label ID="Label7" runat="server" Text="이벤트 이름 : " CssClass="navbar-left"></asp:Label>
                   </li>
                   <li style="margin-right:10px">

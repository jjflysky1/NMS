<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="System_Log.aspx.cs" Inherits="WebApplication1.System_Log" %>
       ...
       <div class="content-wrapper">
            ...
            <section class="content-header">
              ...
              <ol class="breadcrumb">
                ...
                <li class="active"><a href="#">시스템로그</a></li>
              </ol>
            </section>
            ...
            <div class="container-fluid">
                <div style="float:left; text-align: right;  margin-right: 10px; margin-top:-10px; margin-bottom:-10px">
                 ...
                 <div style=" margin-top:-10px; margin-bottom:10px; float:left;">
                    <asp:Button ID="Button4" runat="server" Text="이전" CssClass="btn btn-primary btn-sm" OnClick="Button4_Click" />
                </div>

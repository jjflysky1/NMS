<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="main5.aspx.cs" Inherits="WebApplication1.main5" %>
...
<body class="hold-transition skin-black sidebar-mini  ">
    <%--sidebar-collapse 없애면 왼쪽 메뉴 디폴트 : 펼치기--%>
                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div style="width: 100%; margin-left: 1%;">
                            <%--card card0 border-0--%>
                            <div id="div1" class="card card0 border-0" runat="server" style="float: left; width: 63%; margin-left: 1%; margin-bottom: 1%; margin-top: 0px; z-index: 99;">
                                <div class="grad2">
                                    <%--   <font color="black">
                                    <h5>&nbsp;   장비
                                    </h5>
                    ...
                    <div class="col-auto">
                      <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                            ...
                            <div id="div2" class="card card0 border-0" style="float: left; width: 31%; margin-left: 1%; margin-bottom: 1%; z-index: 99;">
                                <div class="grad2">
                            ...
                            <div class="card card0 border-0" id="box1" style="float: left; text-align: right; width: 31%; margin-top: auto; margin-left: 1%; margin-bottom: 1%; z-index: 99;">
                                <div style="position: absolute; z-index: 10000; float: right; width: 100%;">
                                    <button type="button" id="btn100" class="btn btn- btn-xs" style="visibility: hidden; font-size: 12px; background-color: transparent; color: black; z-index: 10000; width: 60px; height: 20px; margin-top: 5px;"><b>이미지다운</b></button>
                                    <button type="button" id="btn1" class="btn btn- btn-xs" style="font-size: 15px; background-color: transparent; color: black; z-index: 10000; width: 20px; height: 20px;"><b>+</b></button>
                                    <button type="button" id="btn1-1" class="btn btn- btn-xs" style="font-size: 15px; background-color: transparent; color: black; z-index: 10000; width: 20px; height: 20px;"><b>-</b></button>
                                </div>
                                <div class="grad2">
                            ...
                            <div class="card card0 border-0" id="box2" style="float: left; text-align: right; width: 31%; margin-top: auto; margin-left: 1%; margin-bottom: 1%; z-index: 99;">
                                <div style="position: absolute; z-index: 10000; float: right; width: 100%;">
                                    <button type="button" id="btn101" class="btn btn- btn-xs" style="visibility: hidden; font-size: 12px; background-color: transparent; color: black; z-index: 10000; width: 60px; height: 20px; margin-top: 5px;"><b>이미지다운</b></button>
                                    <button type="button" id="btn2" class="btn btn- btn-xs" style="font-size: 15px; background-color: transparent; color: black; z-index: 10000; width: 20px; height: 20px;"><b>+</b></button>
                                    <button type="button" id="btn2-1" class="btn btn- btn-xs" style="font-size: 15px; background-color: transparent; color: black; z-index: 10000; width: 20px; height: 20px;"><b>-</b></button>
                                </div>
                                <div class="grad2">
                            ...
                            <div class="card card0 border-0" id="box3" style="float: left; text-align: right; width: 31%; margin-top: auto; margin-left: 1%; margin-bottom: 1%; z-index: 99;">
                                <div style="position: absolute; z-index: 10000; float: right; width: 100%;">
                                    <button type="button" id="btn102" class="btn btn- btn-xs" style="visibility: hidden; font-size: 12px; background-color: transparent; color: black; z-index: 10000; width: 60px; height: 20px; margin-top: 5px;"><b>이미지다운</b></button>
                                    <button type="button" id="btn3" class="btn btn- btn-xs" style="font-size: 15px; background-color: transparent; color: black; z-index: 10000; width: 20px; height: 20px;"><b>+</b></button>
                                    <button type="button" id="btn3-1" class="btn btn- btn-xs" style="font-size: 15px; background-color: transparent; color: black; z-index: 10000; width: 20px; height: 20px;"><b>-</b></button>
                                </div>
                                <div class="grad2">
                            ...
                            <div class="card card0 border-0" id="box4" style="float: left; width: 31%; text-align: right; margin-top: auto; margin-left: 1%; z-index: 99; margin-bottom: 1%;">
                                <div style="position: absolute; z-index: 10000; float: right; width: 100%;">
                                    <button type="button" id="btn200" class="btn btn- btn-xs" style="visibility: hidden; font-size: 12px; background-color: transparent; color: black; z-index: 10000; width: 60px; height: 20px; margin-top: 5px;"><b>이미지다운</b></button>
                                    <button type="button" id="btn4" class="btn btn- btn-xs" style="font-size: 15px; background-color: transparent; color: black; z-index: 10000; width: 20px; height: 20px;"><b>+</b></button>
                                    <button type="button" id="btn4-1" class="btn btn- btn-xs" style="font-size: 15px; background-color: transparent; color: black; z-index: 10000; width: 20px; height: 20px;"><b>-</b></button>
                                </div>
                                <div class="grad2">
                            ...
                            <div class="card card0 border-0" id="box5" style="float: left; width: 31%; text-align: right; margin-top: auto; margin-left: 1%; z-index: 99; margin-bottom: 1%;">
                                <div style="position: absolute; z-index: 10000; float: right; width: 100%;">
                                    <button type="button" id="btn201" class="btn btn- btn-xs" style="visibility: hidden; font-size: 12px; background-color: transparent; color: black; z-index: 10000; width: 60px; height: 20px; margin-top: 5px;"><b>이미지다운</b></button>
                                    <button type="button" id="btn5" class="btn btn- btn-xs" style="font-size: 15px; background-color: transparent; color: black; z-index: 10000; width: 20px; height: 20px;"><b>+</b></button>
                                    <button type="button" id="btn5-1" class="btn btn- btn-xs" style="font-size: 15px; background-color: transparent; color: black; z-index: 10000; width: 20px; height: 20px;"><b>-</b></button>
                                </div>
                                <div class="grad2">
                            ...
                            <div class="card card0 border-0" id="box6" style="float: left; width: 31%; text-align: right; margin-top: auto; margin-left: 1%; z-index: 99; margin-bottom: 1%;">
                                <div style="position: absolute; z-index: 10000; float: right; width: 100%;">
                                    <button type="button" id="btn202" class="btn btn- btn-xs" style="visibility: hidden; font-size: 12px; background-color: transparent; color: black; z-index: 10000; width: 60px; height: 20px; margin-top: 5px;"><b>이미지다운</b></button>
                                    <button type="button" id="btn6" class="btn btn- btn-xs" style="font-size: 15px; background-color: transparent; color: black; z-index: 10000; width: 20px; height: 20px;"><b>+</b></button>
                                    <button type="button" id="btn6-1" class="btn btn- btn-xs" style="font-size: 15px; background-color: transparent; color: black; z-index: 10000; width: 20px; height: 20px;"><b>-</b></button>
                                </div>
                                <div class="grad2">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    <div id="div4" class="card card0 border-0" runat="server" style="float: left; width: 63%; margin-left: 1%; z-index: 99;">
                                        <div class="grad2">
                                            <p></p>
                                            <center>
                                                <font color="black">
                            ...
                            <div class="card card0 border-0" style="float: left; height: 100%; width: 31%; margin-top: auto; margin-left: 1%; z-index: 99; margin-bottom: 1%;">
                                <div class="grad2">
                                    <div id="div300" style="width: 100%; height: 192px; margin-top: 0px;">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                <ContentTemplate>
                                    <div id="div3" class="card card0 border-0" runat="server" style="float: left; height: 100%; width: 63%; margin-left: 1%; margin-top: 10px; z-index: 99;">
                                        <div class="grad2">
                                            <p></p>
                                            <center>
                                                <font color="black">
                            ...
                            <div class="card card0 border-0" style="float: left; height: 100%; width: 31%; margin-top: auto; margin-left: 1%; margin-right: 4%; margin-top: 10px; z-index: 99;">
                                <div class="grad2">
                                    <div id="div400" style="width: 100%; height: 192px; margin-top: 0px;">

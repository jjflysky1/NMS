<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="user.aspx.cs" Inherits="WebApplication1.user" %>
       ...
       <div class="content-wrapper">
            ...
            <section class="content-header">
              ...
              <ol class="breadcrumb">
                ...
                <li class="active"><a href="#">사용자리스트</a></li>
              </ol>
            </section>
		    ...
		    <div  class="navbar-btn" style="margin-right: 10px" >
                ...
                <ui  class="nav navbar-nav navbar-right">
                    <li style="margin-top:5px; margin-right:10px">
                        <asp:Label ID="Label6" runat="server" Text="아이디 :" CssClass="navbar-left" ></asp:Label>
                    </li>
                    <li style=" margin-right:10px">
                        <asp:TextBox ID="TextBox1" Height="30" Width="140" runat="server" Class="form-control"></asp:TextBox>
                    </li>

                   <li style="margin-top:5px;  margin-right:10px">
                       <asp:Label ID="Label7" runat="server" Text="패스워드 : " CssClass="navbar-left"></asp:Label>
                   </li>
                   <li style="margin-right:10px">
                       <asp:TextBox ID="TextBox2" Height="30" Width="140" runat="server" Class="form-control"></asp:TextBox>
                   </li>


                   <li style="margin-top:5px;  margin-right:10px">
                       <asp:Label ID="Label8" runat="server" Text="이름 : " CssClass="navbar-left"></asp:Label>
                   </li>
                    <li style="margin-right:10px">
                       <asp:TextBox ID="TextBox3" Height="30" Width="140" runat="server" Class="form-control"></asp:TextBox>
                   </li>
                    ...
                    <li style="margin-top:5px;  margin-right:10px">
                       <asp:Label ID="Label2" runat="server" Text="메일 : " CssClass="navbar-left"></asp:Label>
                   </li>
                    <li style="margin-right:10px">
                       <asp:TextBox ID="TextBox6" Height="30" Width="140" runat="server" Class="form-control"></asp:TextBox>
                   </li>

                  <%--   <li style="margin-top:5px;  margin-right:10px">
                       <asp:Label ID="Label4" runat="server" Text="연락처 : " CssClass="navbar-left"></asp:Label>
                   </li>--%>
                  <%--  <li style="margin-right:10px">
                       <asp:TextBox ID="TextBox7" Height="30" Width="140" runat="server" Class="form-control"></asp:TextBox>
                   </li>--%>

    ...
    public partial class Chart3 : System.Web.UI.Page
    {
        ...
        public void chart()
        {
            ...
            try
            {
                ...
                MySqlDataAdapter ADT3 = new MySqlDataAdapter("Traffic_top_server", DB);
        ...
        private DataTable GetChartData3(string query3)
        {
            ...
            MySqlCommand cmd2 = new MySqlCommand(query3, DB);
            MySqlDataAdapter ADT2 = new MySqlDataAdapter();
        ...
        public static List<Customer> chart1()
        {
            ...
            //string SQL1 = "select distinct  serverip, sum(traffic) AS traffic from System_Log_Traffic where time >= DATE_SUB(NOW(), INTERVAL 10 MINUTE) GROUP BY serverip order by traffic desc LIMIT 10";
            ...
            //string SQL = "select  serverip, round((traffic / 1024 / 1024),2) as traffic, concat(DATE_FORMAT(time, '%e'), '일',left(DATE_FORMAT(time, '%T'),5)) as temptime from System_Log_Traffic where serverip = " +
            ...
            string SQL2 = "select serverip, round((traffic / 1024 / 1024),2) as traffic, left(DATE_FORMAT(time, '%T'),5) as temptime from system_log_traffic where serverip = " +
             "'" + serverip[0] + "'     order by time desc limit 60";
        ...
        public static List<Customer2> chart2()
        {
            ...
            //    {
            //        serverip2 = row1["serverip"].ToString(),
            ...
            //string SQL3 = "select mac from Secure_Port_Traffic where concat(serverip , ' ' , portname) ='" + serverip[4] + "'";
            //MySqlDataAdapter ADT5 = new MySqlDataAdapter(SQL3, DB);
            //DataSet DBSET5 = new DataSet();
            //ADT5.Fill(DBSET5, "BD");
            //string mac = "";
        ...
        public static List<Customer3> chart3()
        {
            ...
            //string SQL3 = "select mac from Secure_Port_Traffic where concat(serverip , ' ' , portname) ='" + serverip[5] + "'";
            //MySqlDataAdapter ADT5 = new MySqlDataAdapter(SQL3, DB);
            //DataSet DBSET5 = new DataSet();
            //ADT5.Fill(DBSET5, "BD");
            //string mac = "";
        ...
        public static List<Customer4> chart4()
        {
            ...
            string SQL = "SELECT * FROM service WHERE CPU IS NOT null ORDER BY CPU DESC limit 5";
            MySqlDataAdapter ADT4 = new MySqlDataAdapter(SQL, DB);
            DataSet DBSET4 = new DataSet();
            ADT4.Fill(DBSET4, "BD4");
            foreach (DataRow row1 in DBSET4.Tables["BD4"].Rows)
        ...
        [WebMethod]
        public static List<Customer5> chart5()
        {
            MySqlConnection DB = new MySqlConnection(ConfigurationManager.ConnectionStrings["LocalSqlServer"].ConnectionString);
            List<Customer5> Parts5 = new List<Customer5>();
            Parts5.Clear();


            string SQL = "SELECT serverip, memory FROM service WHERE memory IS NOT NULL ORDER BY memory DESC LIMIT 5 ";
            MySqlDataAdapter ADT4 = new MySqlDataAdapter(SQL, DB);
            DataSet DBSET4 = new DataSet();
            ADT4.Fill(DBSET4, "BD4");
            foreach (DataRow row1 in DBSET4.Tables["BD4"].Rows)
            {
                Parts5.Add(new Customer5
                {
                    serverip3 = row1["serverip"].ToString(),
                    memory = row1["memory"].ToString()
                });
            ...
            //string iresurlt = "";
            //iresurlt = JsonConvert.SerializeObject(Parts5);

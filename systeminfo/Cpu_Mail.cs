...
namespace systeminfo
{
    class Cpu_Mail
    {
        public void cpu_sendmail(string serverip, string nowcpu)
        {
            ...
            string SQL = "";
            SQL = "select distinct   a.email, a.mailno , c.mailip, c.cpulimit, mail_sender from mail_target a , service b ,  mail_info c where  c.flag=1 and DATEADD(minute, 10, b.cpumail) < GETDATE() and a.serverip = b.ServerIP " +

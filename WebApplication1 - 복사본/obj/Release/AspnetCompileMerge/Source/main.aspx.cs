...
namespace WebApplication1
{
    public partial class main : System.Web.UI.Page
    {
        ...
        private void TBLSET0()
        {
            ...
            TD.Text = " <img src='img/iconmonstr-cube-1-240.png' width='50px' height='50px' /><br><font size='4'><a href='Service/Service.aspx' style='color:black'>Total</a></font>";
            ...
            TD = new TableHeaderCell();
            TD.Width = new Unit("10%");
            TD.Text = " <img src='img/iconmonstr-monitoring-6-240.png' width='50px' height='50px' /><br><font size='4'>Management Amount</font>";
            TD.Attributes["style"] = "text-align : center; cursor:pointer;";
            ...
            TD = new TableHeaderCell();
            TD.Width = new Unit("10%");
            TD.Text = " <img src='img/iconmonstr-firewall-2-240.png' width='50px' height='50px' /><br><font size='4'>Network / Security</font>";
            TD.Attributes["style"] = "text-align : center;  cursor:pointer; ";
            ...
            TD = new TableHeaderCell();
            TD.Width = new Unit("10%");
            TD.Text = " <img src='img/iconmonstr-server-7-240.png' width='50px' height='50px' /><br><font size='4'>Server</font>";
            TD.Attributes["style"] = "text-align : center;  cursor:pointer; ";
            ...
            TD = new TableHeaderCell();
            TD.Width = new Unit("10%");
            TD.Text = " <img src='img/iconmonstr-laptop-1-240.png' width='50px' height='50px' /><br><font size='4'>PC</font>";
            TD.Attributes["style"] = "text-align : center;  cursor:pointer; ";
            ...
            TD = new TableHeaderCell();
            TD.Width = new Unit("10%");
            TD.Text = " <img src='img/iconmonstr-minus-2-240.png' width='50px' height='50px' /><br><font size='4'>NONE</font>";
            TD.Attributes["style"] = "text-align : center; cursor:pointer; ";
            ...
            TD = new TableHeaderCell();
            TD.Width = new Unit("10%");
            TD.Text = " <img src='img/iconmonstr-stop-3-240.png' width='50px' height='50px' /><br><font size='4'>Serivce Down</font> ";
            TD.Attributes["style"] = "text-align : center; cursor:pointer; ";
        ...
        {
            SQL = "select distinct top 3 os,name,serverip,serverid,serverpwd,status,network_name,computer_name,category from Service where status <> 'Server Connect' and flag = 1 and category <> N'네트워크/보안 장비' ";
        ...
        {
            SQL = "select top 3 * from Service where status <> 'Server Connect' and flag = 1 and category = N'네트워크/보안 장비' ";
        ...
        {
            SqlDataAdapter ADT = new SqlDataAdapter("Server_resource_list", DB);
        ...
        private void TBLLOAD3_1()
        {
                ...
                SqlDataAdapter ADT = new SqlDataAdapter("Secure_resource_list", DB);
                ADT.SelectCommand.CommandType = CommandType.StoredProcedure;
                DataSet DBSET = new DataSet();
                ADT.Fill(DBSET, "BD");
                foreach (DataRow row in DBSET.Tables["BD"].Rows)
        ...
        {
            SQL = "select distinct top 5 b.computer_name, b.network_name, a.serverip, round(a.traffic,2) as traffic, b.pingtime , category,c.trafficlimit , c.mailip from server_traffic a, service b , mail_info c " +
                "where traffic is not null and a.serverip = b.ServerIP and b.status = 'Server Connect' and b.flag = 1 order by traffic desc";
        ...
        public void TBLLOAD5()
        {
            ///다운된 서비스
            string downcount = "";
            SQL = "select count(name) as count, CONVERT(CHAR(10), GETDATE(), 23) as getdate, left(datename(DW,GETDATE()),1) as name, CONVERT(CHAR(8), GETDATE(), 24) as time  from down_log where left(time, 10) = LEFT(GETDATE(), 10) and status = 'down'";
            ...
            SqlDataAdapter ADT3 = new SqlDataAdapter("Traffic_top", DB);
            ...
            SqlDataAdapter ADT5 = new SqlDataAdapter(SQL, DB);
            ...
            //메모리 top
            SQL = "select distinct top 1 serverip, memory from Service where status = 'Server Connect' and flag = '1'  order by memory desc";
        ...
        {
            SQL = "select top 5 count(*) count,app from server_app group by app order by count desc";
        ...
        private void TBLADD0(string allcount, string alivecount, string Server,  string security, string pc, string none, string downcount)
        {
            ...
            TD = new TableCell();
            TD.Width = 60;
            TD.Text = "<font size='5'><b><a href='Service/Service.aspx' style='color:black'>" + allcount.ToString() + "</a></b></font>";

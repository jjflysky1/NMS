...
<body>
    ...
    <div class="modal-header">
            ...
            <div class="modal-body">
                <div style="width:500px; margin-left:auto; margin-right:auto; " >
						...
						<div class="form-group">
							<label for="email" class="cols-sm-2 control-label">메일 아이피</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-envelope fa" aria-hidden="true"></i></span>
									<input type="text" runat="server" class="form-control" name="startip" id="mailip"  placeholder="Enter your IP"/>
								</div>
							</div>
						</div>
                    ...
                    <div class="form-group">
							<label for="username" class="cols-sm-2 control-label">트래픽 기준(B/S)</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-users fa" aria-hidden="true"></i></span>
        ...
        <asp:HiddenField ID="MAILSENDER" runat="server" />
                <asp:HiddenField ID="MAILIPHF" runat="server" />

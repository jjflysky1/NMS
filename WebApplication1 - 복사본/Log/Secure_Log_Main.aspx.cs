...
namespace WebApplication1
{
    ...
    public partial class Secure_Log_Main : System.Web.UI.Page
    {
        ...
        private void TBLLOAD()
        {
            ...
            SqlDataAdapter ADT = new SqlDataAdapter("Secure_Log_list_main", DB);
        ...
        private void PAGEADD(int pagecount, int nowpage)
        {
            ...
            SB.Append("<li>" + "<a href='Secure_Log.aspx?nowpage=" + 1 + "&search=" + Search.Text + "&type=" + DropDownList1.SelectedValue + "&type2=" + DropDownList2.SelectedValue + "'>" + "<span aria-hidden='true'> &laquo;</span>" + "</a>" + "<li>");
            if (nowpage > 5)
            {
                nowpage = nowpage - 3;
            }
            ...
            for (int i = nowpage; i < pagecount; i++)
            {
                ...
                SB.Append("<li> " + "<a href='Secure_Log.aspx?nowpage=" + i + "&search=" + Search.Text + "&type=" + DropDownList1.SelectedValue + "&type2=" + DropDownList2.SelectedValue + "'>" + i + "</a>" + " <li>");

            }
            SB.Append("<li>" + "<a href='Secure_Log.aspx?nowpage=" + (pagecount - 1) + "&search=" + Search.Text + "&type=" + DropDownList1.SelectedValue +"&type2=" + DropDownList2.SelectedValue + "'>" + "<span aria-hidden='true'> &raquo;</span>" + "</a>" + "<li>");

...
namespace WebApplication1
{
    ...
    public partial class Secure_Log : System.Web.UI.Page
    {
        ...
        private void TBLLOAD()
        {
            ...
            string SQL2 = "select count(*) as count from Secure_log where time between '" + startdate.Text + "' and '" + enddate.Text + "' and serverip like '%" + serverip.Value + "%'";
            if (DropDownList1.SelectedValue == "1")
            {
                SQL2 = "select count(*) as count from Secure_log where serverip like '%" + Search.Text + "%' and time between '" + startdate.Text + "' and '" + enddate.Text + "'";
            ...
            {
                SQL2 = "select count(*) as count from Secure_log where time like '%" + Search.Text + "%'  and time between '" + startdate.Text + "' and '" + enddate.Text + "'";
            }
            else if (DropDownList1.SelectedValue == "4")
            {
                SQL2 = "select count(*) as count from Secure_log where status like '%" + Search.Text + "%'  and time between '" + startdate.Text + "' and '" + enddate.Text + "'";
            }
            ...
            else
            {
                ADT.SelectCommand.Parameters.AddWithValue("@search", "where time between '" + startdate.Text + "' and '" + enddate.Text + "' " +
                    "and serverip like '%"+ serverip.Value + "%'");
                //ADT.SelectCommand.Parameters.AddWithValue("@where", " no >= " + start + " and no <= " + end);
                ADT.SelectCommand.Parameters.AddWithValue("@where", " no >= " + start + " and no <= " + end);
            }
        ...
        private void count()
        {
            SQL = "select count(*) as count from Secure_Log where time between '" + startdate.Text + "' and '" + enddate.Text + "' and serverip like '%" + serverip.Value + "%'";

            if (DropDownList1.SelectedValue == "1")
            {
                SQL = "select count(*) as count from Secure_Log where serverip like '%" + Search.Text + "%' and time between '" + startdate.Text + "' and '" + enddate.Text + "'";
            ...
            {
                SQL = "select count(*) as count from Secure_Log where time like '%" + Search.Text + "%'  and time between '" + startdate.Text + "' and '" + enddate.Text + "'";
            }
            else if (DropDownList1.SelectedValue == "4")
            {
                SQL = "select count(*) as count from Secure_Log where status like '%" + Search.Text + "%'  and time between '" + startdate.Text + "' and '" + enddate.Text + "'";
            }
        ...
        private void PAGEADD(int pagecount, int nowpage)
        {
            ...
            SB.Append("<li>" + "<a href='Secure_Log.aspx?nowpage=" + 1 + "&search=" + Search.Text + "&type=" + DropDownList1.SelectedValue + "&startdate=" +
                "" + startdate.Text + "&enddate=" + enddate.Text + "&type2=" + DropDownList2.SelectedValue + "&serverip="+ serverip.Value +"'>" + "<span aria-hidden='true'> &laquo;</span>" + "</a>" + "<li>");
            if (nowpage > 5)
            {
                nowpage = nowpage - 3;
            }
            ...
            for (int i = nowpage; i < pagecount; i++)
            {
                ...
                SB.Append("<li> " + "<a href='Secure_Log.aspx?nowpage=" + i + "&search=" + Search.Text + "&type=" + DropDownList1.SelectedValue + "&startdate=" +
                    "" + startdate.Text + "&enddate=" + enddate.Text + "&type2=" + DropDownList2.SelectedValue + "&serverip=" + serverip.Value + "'>" + i + "</a>" + " <li>");

            }
            SB.Append("<li>" + "<a href='Secure_Log.aspx?nowpage=" + (pagecount - 1) + "&search=" + Search.Text + "&type=" + DropDownList1.SelectedValue + "&startdate=" +
                "" + startdate.Text + "&enddate=" + enddate.Text + "&type2=" + DropDownList2.SelectedValue + "&serverip=" + serverip.Value + "'>" + "<span aria-hidden='true'> &raquo;</span>" + "</a>" + "<li>");
        ...
        protected void Button6_Click(object sender, EventArgs e)
        {
            ...
            string SQL2 = "select count(*) as count from Secure_Log where time between '" + startdate.Text + "' and '" + enddate.Text + "'";
            if (DropDownList1.SelectedValue == "1")
            {
                SQL2 = "select count(*) as count from Secure_Log where serverip like '%" + Search.Text + "%' and time between '" + startdate.Text + "' and '" + enddate.Text + "'";
